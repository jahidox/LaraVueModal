...
<head>
  ...
  <title>Laravel | VueJs | Modals | VueRouter</title>
...
<div class="wrapper" id="app">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="./img/admin.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">LaravelVueModel</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <router-link to="/developer" href="#" class="nav-link">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('logout') }}"
              ...
              <i class="nav-icon fa fa-power-off text-blue"></i>
              <p>
              {{ __('Logout') }}
              </p>
            </a>
